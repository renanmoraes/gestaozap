/* @ds-bundle: {"format":3,"namespace":"GestaoZap_b11496","components":[],"sourceHashes":{"landing/landing.js":"a21f4bb4f463","landing/tweaks-app.jsx":"5ff233e9fb55","landing/tweaks-panel.jsx":"6591467622ed"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.GestaoZap_b11496 = window.GestaoZap_b11496 || {});
...
(function () {
  ...
  function raf() {
    ...
    if (stageInner) {
      ...
      stageInner.style.transform = `translateY(${ty}px) scale(${sc}) rotateX(${rx}deg) rotateY(${ry}deg)`;
    }
  ...
  document.querySelectorAll('[data-qr]').forEach(box => {
    ...
    for (let y = 0; y < N; y++) for (let x = 0; x < N; x++) {
      ...
      if (rnd() > 0.56) {
        const r = document.createElementNS(svgNS, 'rect');
        r.setAttribute('x', x * cell + cell * 0.1);
        r.setAttribute('y', y * cell + cell * 0.1);
        r.setAttribute('width', cell * 0.8);
        r.setAttribute('height', cell * 0.8);
        r.setAttribute('rx', cell * 0.22);
        r.setAttribute('fill', '#0f172a');
        svg.appendChild(r);
      }
    }
    finder(0, 0);
...
(function mount() {
  ...
  ReactDOM.createRoot(root).render(/*#__PURE__*/React.createElement(TweaksApp, null));
})();
})(); } catch (e) { __ds_ns.__errors.push({ path: "landing/tweaks-app.jsx", error: String((e && e.message) || e) }); }
